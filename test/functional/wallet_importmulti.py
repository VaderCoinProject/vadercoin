...
class ImportMultiTest(VadercoinTestFramework):
    ...
    def run_test(self):
        ...
        # Vadercoin Address (implicit non-internal)
        ...
        self.test_importmulti(
            {
                "scriptPubKey": {"address": "ncrt1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vq9uezh2"},
                "timestamp": "now",
            },
            success=False,
            error_code=-5,
