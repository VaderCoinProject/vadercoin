...
class WalletTest(VadercoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 VADE from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 VADE with subtract fee from amount
        ...
        # Sendmany 10 VADE with subtract fee from amount
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid Vadercoin address
            assert_raises_rpc_error(-5, "Invalid address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid Vadercoin address
            ...
            assert_raises_rpc_error(-5, "Bech32m addresses cannot be imported into legacy wallets", self.nodes[0].importaddress, "ncrt1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vq9uezh2")
