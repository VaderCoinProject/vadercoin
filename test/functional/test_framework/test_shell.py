...
class TestShell:
    """Wrapper Class for VadercoinTestFramework.

    The TestShell class extends the VadercoinTestFramework
    ...
    class __TestShell(VadercoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by VadercoinTestFramework child class.
            self.num_nodes = 1
