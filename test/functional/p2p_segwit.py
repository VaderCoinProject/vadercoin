...
class SegWitTest(VadercoinTestFramework):
    ...
    def run_test(self):
        ...
        # Upstream Vadercoin backdated the script verification softfork,
        # which we cannot do yet until segwit activates on Vadercoin.
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older vadercoind's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let vadercoind fill it in.
