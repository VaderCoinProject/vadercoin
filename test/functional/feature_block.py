...
class FullBlockTest(VadercoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure vadercoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure vadercoind isn't accepting b28
        ...
        # In Vadercoin, we have to respect the BDB lock limit as well.
        ...
        # Tests for P2SH sigop limits have been removed in Vadercoin because
        ...
        # Upstream Vadercoin tests BIP30 here.  We cannot do that, as BIP34 is
        ...
        # vadercoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the vadercoin code has custom code which does so);
