...
By default, vadercoind will dump mempool on shutdown and
...
class MempoolPersistTest(VadercoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent vadercoind from writing mempool.dat to disk. Verify that `savemempool` fails")
