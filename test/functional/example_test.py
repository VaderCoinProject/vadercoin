...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the VadercoinTestFramework
    pass


class ExampleTest(VadercoinTestFramework):
    # Each functional test is a subclass of the VadercoinTestFramework class.
    ...
    def custom_method(self):
        ...
        VadercoinTestFramework class so other tests can use it."""
