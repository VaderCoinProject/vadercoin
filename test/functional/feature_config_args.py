...
class ConfArgsTest(VadercoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        main_conf_file_path = os.path.join(self.options.tmpdir, 'node0', 'vadercoin_main.conf')
        ...
        with open(os.path.join(self.nodes[0].datadir, 'vadercoin.conf'), 'a', encoding='utf-8') as conf:
