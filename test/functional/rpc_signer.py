...
Verify that a vadercoind node can use an external signer command.
...
class RPCSignerTest(VadercoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart vadercoind with -signer=<cmd>',
