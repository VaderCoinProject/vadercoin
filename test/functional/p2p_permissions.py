...
class P2PPermissionsTests(VadercoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].vadercoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].vadercoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
