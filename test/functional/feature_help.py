...
"""Verify that starting vadercoin with -h works as expected."""

from test_framework.test_framework import VadercoinTestFramework
from test_framework.util import assert_equal

class HelpTest(VadercoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vadercoin with -h for help text")
        ...
        self.log.info("Start vadercoin with -version for version information")
        ...
        self.log.info("Start vadercoind with -fakearg to make sure it does not start")
