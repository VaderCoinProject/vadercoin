...
class PSBTTest(VadercoinTestFramework):

    def set_test_params(self):
        self.num_nodes = 3
        # Upstream Vadercoin has segwit as default address type and this
        # test depends on that.  Since we changed it (for now, pending
        # segwit activation in Vadercoin), explicitly specify the address
        # type for this test.
        self.extra_args = [
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 VADE
        ...
        self.log.info("Test walletcreatefundedpsbt fee rate of 10000 sat/vB and 0.1 VADE/kvB produces a total fee at or slightly below -maxtxfee (~0.05290000)")
