...
// vadercoin includes.
#include <..\src\script\vadercoinconsensus.h>
...
int main()
{
    std::cout << "vadercoinconsensus version: " << vadercoinconsensus_version() << std::endl;
    ...
    auto op0Result = vadercoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, vadercoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
