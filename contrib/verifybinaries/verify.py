...
vadercoincore.org and vadercoin.org and compares them.
...
WORKINGDIR = "/tmp/vadercoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://vadercoincore.org"
HOST2 = "https://vadercoin.org"
VERSIONPREFIX = "vadercoin-core-"
...
def main(args):
    ...
    if not success:
        print("vadercoin.org failed to provide signature file, "
              "but vadercoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("vadercoin.org and vadercoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Vadercoin Core binary release "
