#!/bin/sh
# Copyright (c) 2017-2019 The Vadercoin Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the vadercoin repository."
  exit 1
fi
...
# See https://github.com/vadercoin/vadercoin/issues/16064
...
echo 'When compiling vadercoind, run `./configure` in the following way:'
echo
