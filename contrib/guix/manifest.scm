...
(define* (make-vadercoin-cross-toolchain target
                                       #:key
...
desirable for building Vadercoin Core release binaries."
...
(define glibc-2.27/vadercoin-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-vadercoin-cross-toolchain target
                                                      #:base-libc glibc-2.27/vadercoin-patched
