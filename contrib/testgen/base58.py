...
'''
Vadercoin base58 encoding and decoding.

Based on https://vadercointalk.org/index.php?topic=1026.0 (public domain)
'''
import hashlib
...
def b58encode(v):
    ...
    # Vadercoin does a little leading-zero-compression:
...
if __name__ == '__main__':
    # Test case (from http://gitorious.org/vadercoin/python-base58.git)
