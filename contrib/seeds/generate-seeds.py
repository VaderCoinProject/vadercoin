...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef VADERCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define VADERCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the vadercoin network\n')
    ...
    g.write('#endif // VADERCOIN_CHAINPARAMSSEEDS_H\n')
