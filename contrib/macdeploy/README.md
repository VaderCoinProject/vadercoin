...
When complete, it will have produced `Vadercoin-Core.dmg`.
...
apt install cpio
git clone https://github.com/vadercoin-core/apple-sdk-tools.git
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/vadercoin-core/vadercoin-detached-sigs).
