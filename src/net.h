...
#ifndef VADERCOIN_NET_H
#define VADERCOIN_NET_H
 ...
 * currently acceptable).  Vadercoin has 4 MiB here, but we need more space
 ...
 * src/qt/guiutil.cpp and src/vadercoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Vadercoin’s Peer-to-Peer Network")
