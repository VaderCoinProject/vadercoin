...
#ifndef VADERCOIN_CHAINPARAMS_H
#define VADERCOIN_CHAINPARAMS_H
...
public:
    ...
    enum BugType {
        ...
        /* Don't apply the name operations but put the names into the UTXO
           set.  This is done for libcoin's "d/vadercoin" stealing.  It is
        ...
        /* Don't apply the name operations and don't put the names into the
           ...
           for the NAME_FIRSTUPDATE's that are in non-Vadercoin tx.  */
        BUG_FULLY_IGNORE,
    };
