...
#ifndef VADERCOIN_TEST_SCRIPTNUM10_H
#define VADERCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Vadercoin Core 0.10.0, for cross-comparison.
 */
public:
