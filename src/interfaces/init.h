...
#ifndef VADERCOIN_INTERFACES_INIT_H
#define VADERCOIN_INTERFACES_INIT_H
...
//! (vadercoin-gui, vadercoin-node, vadercoin-wallet, vadercoind, vadercoin-qt) and each
...
#endif // VADERCOIN_INTERFACES_INIT_H
