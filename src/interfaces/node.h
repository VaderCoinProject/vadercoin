...
#ifndef VADERCOIN_INTERFACES_NODE_H
#define VADERCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a vadercoin node (vadercoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // VADERCOIN_INTERFACES_NODE_H
