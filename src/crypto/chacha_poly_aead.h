...
#ifndef VADERCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define VADERCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@vadercoin.
 *
 ...
 *
 * The chacha20-poly1305@vadercoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@vadercoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@vadercoin are relatively fast in
...
#endif // VADERCOIN_CRYPTO_CHACHA_POLY_AEAD_H
