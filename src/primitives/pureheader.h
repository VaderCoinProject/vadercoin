...
// Copyright (c) 2009-2013 The Vadercoin developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef VADERCOIN_PRIMITIVES_PUREHEADER_H
#define VADERCOIN_PRIMITIVES_PUREHEADER_H
...
#endif // VADERCOIN_PRIMITIVES_PUREHEADER_H
