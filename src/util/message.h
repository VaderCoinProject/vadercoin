...
#ifndef VADERCOIN_UTIL_MESSAGE_H
#define VADERCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's vadercoin address, it must refer to a public key.
...
#endif // VADERCOIN_UTIL_MESSAGE_H
