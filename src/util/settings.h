...
#ifndef VADERCOIN_UTIL_SETTINGS_H
#define VADERCOIN_UTIL_SETTINGS_H
...
//!       https://github.com/vadercoin/vadercoin/pull/15934/files#r337691812)
...
#endif // VADERCOIN_UTIL_SETTINGS_H
