 ...
 */
#ifndef VADERCOIN_UTIL_SYSTEM_H
#define VADERCOIN_UTIL_SYSTEM_H
...
extern const char * const VADERCOIN_CONF_FILENAME;
extern const char * const VADERCOIN_SETTINGS_FILENAME;
