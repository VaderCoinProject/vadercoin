...
#ifndef VADERCOIN_SCRIPT_STANDARD_H
#define VADERCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a vadercoin address
 */
...
/**
 * Generate a Vadercoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // VADERCOIN_SCRIPT_STANDARD_H
