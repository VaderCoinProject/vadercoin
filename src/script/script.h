...
#ifndef VADERCOIN_SCRIPT_SCRIPT_H
#define VADERCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Vadercoin always counted CHECKMULTISIGs
     ...
     * name prefix before performing the strict check from Vadercoin.
...
#endif // VADERCOIN_SCRIPT_SCRIPT_H
