...
#ifndef VADERCOIN_CONSENSUS_PARAMS_H
#define VADERCOIN_CONSENSUS_PARAMS_H
...
public:
    ...
    virtual CAmount MinVaderCoinAmount(unsigned nHeight) const = 0;
...
public:
    ...
    CAmount MinVaderCoinAmount(unsigned nHeight) const override
    {
        if (nHeight < 212500)
            return 0;
...
public:
    ...
    CAmount MinVaderCoinAmount(unsigned) const override
    {
        return COIN / 100;
    }
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a Vadercoin Script solution
...
#endif // VADERCOIN_CONSENSUS_PARAMS_H
