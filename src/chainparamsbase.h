...
#ifndef VADERCOIN_CHAINPARAMSBASE_H
#define VADERCOIN_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between vadercoin-cli and vadercoind)
 * of a given instance of the Vadercoin system.
 */
...
#endif // VADERCOIN_CHAINPARAMSBASE_H
