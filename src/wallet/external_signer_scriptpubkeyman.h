...
#ifndef VADERCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define VADERCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // VADERCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
