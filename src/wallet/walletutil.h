...
#ifndef VADERCOIN_WALLET_WALLETUTIL_H
#define VADERCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! vadercoin from opening the wallet, thinking it was newly created, and
...
#endif // VADERCOIN_WALLET_WALLETUTIL_H
