...
#ifndef VADERCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define VADERCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Vadercoin Core wallet was originally a collection of unrelated private
...
public:
     ...
     *  keys.  This is something we need for Vadercoin's deterministic salts
...
#endif // VADERCOIN_WALLET_SCRIPTPUBKEYMAN_H
