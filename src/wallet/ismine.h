...
#ifndef VADERCOIN_WALLET_ISMINE_H
#define VADERCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/vadercoin/vadercoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // VADERCOIN_WALLET_ISMINE_H
