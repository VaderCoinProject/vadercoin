 ...
 * for both vadercoind and vadercoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Anakin");
...
#define GIT_COMMIT_ID "cea5a7e7ac824a2acf45f5fbce2f02da0c1147b0"
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/vadercoin/bips/blob/master/bip-0014.mediawiki)
 */
