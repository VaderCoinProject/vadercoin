...
#ifndef VADERCOIN_MINER_H
#define VADERCOIN_MINER_H
...
private:
    ...
    /**
     * Verify if a tx can be added from a Vadercoin perspective.  This may not
     ...
     */
    bool TxAllowedForVadercoin(const CTransaction& tx) const;
    /** Check DB lock limit.  */
