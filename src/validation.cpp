...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    if (!m_pool.CalculateMemPoolAncestors(*entry, setAncestors, m_limit_ancestors, m_limit_ancestor_size, m_limit_descendants, m_limit_descendant_size, errString)) {
        ...
        // this, see https://lists.linuxfoundation.org/pipermail/vadercoin-dev/2018-November/016518.html
...
bool MemPoolAccept::ConsensusScriptChecks(const ATMPArgs& args, Workspace& ws, PrecomputedTransactionData& txdata)
{
    ...
    //
    // Vadercoin actually allows some scripts into the mempool that would
...
/* Temporary check that blocks are compatible with BDB's 10,000 lock limit.
   This is based on Vadercoin's commit 8c222dca4f961ad13ec64d690134a40d09b20813.
   ...
   In addition, each Vadercoin transaction could touch at most one name,
   so add them as well.  */
...
bool ChainstateManager::ProcessNewBlock(const CChainParams& chainparams, const std::shared_ptr<const CBlock>& block, bool force_processing, bool* new_block)
{
...

    {
        ...
        // https://lists.linuxfoundation.org/pipermail/vadercoin-dev/2019-February/016697.html.  Because CheckBlock() is
