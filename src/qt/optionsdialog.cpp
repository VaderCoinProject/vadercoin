    ...
    mapper(nullptr)
{
    ...
    ui->vadercoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->vadercoinAtStartup);
    ...
    ui->vadercoinAtStartup->setToolTip(ui->vadercoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->vadercoinAtStartup->setText(ui->vadercoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openVadercoinConfButton->setToolTip(ui->openVadercoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new VadercoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->vadercoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openVadercoinConfButton_clicked()
{
