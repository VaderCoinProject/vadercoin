...
#ifndef VADERCOIN_QT_GUIUTIL_H
#define VADERCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Vadercoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "vadercoin:" URI into recipient object, return true on successful parsing
