...
#ifndef VADERCOIN_QT_VADERCOINGUI_H
#define VADERCOIN_QT_VADERCOINGUI_H
...
/**
  Vadercoin GUI main class. This class represents the main window of the Vadercoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class VadercoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit VadercoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~VadercoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a vadercoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Vadercoin Transaction from file or clipboard */
...
#endif // VADERCOIN_QT_VADERCOINGUI_H
