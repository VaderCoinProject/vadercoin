    ...
    platformStyle(_platformStyle)
{
    ...
    // normal vadercoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying vadercoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &VadercoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
