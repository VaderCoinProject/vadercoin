...
//! Entry point for VadercoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &VadercoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for VadercoinGUI tests.
void AppTests::guiTests(VadercoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &VadercoinGUI::consoleShown, this, &AppTests::consoleTests);
