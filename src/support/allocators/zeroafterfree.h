...
#ifndef VADERCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define VADERCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // VADERCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
