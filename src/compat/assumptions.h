...
#ifndef VADERCOIN_COMPAT_ASSUMPTIONS_H
#define VADERCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Vadercoin cannot be compiled without assertions."
#endif
...
#endif // VADERCOIN_COMPAT_ASSUMPTIONS_H
