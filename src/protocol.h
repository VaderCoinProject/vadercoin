...
#ifndef VADERCOIN_PROTOCOL_H
#define VADERCOIN_PROTOCOL_H
...
/**
 * Vadercoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Vadercoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Vadercoin Core nodes used to support this by default, without advertising this bit,
    ...
    // vadercoin-development mailing list. Remember that service bits are just
