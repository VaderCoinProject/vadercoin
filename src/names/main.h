...
#ifndef H_VADERCOIN_NAMES_MAIN
#define H_VADERCOIN_NAMES_MAIN
...
/**
 * Check a transaction according to the additional Vadercoin rules.  This
 * ensures that all name operations (if any) are valid and that it has
 * name operations iff it is marked as Vadercoin tx by its version.
