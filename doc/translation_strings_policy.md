...
This document provides guidelines for internationalization of the Vadercoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vadercoin_en.ts` remains unchanged.
