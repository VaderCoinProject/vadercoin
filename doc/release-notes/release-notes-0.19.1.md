...
Vadercoin Core version 0.19.1 is now available from:

  <https://vadercoincore.org/bin/vadercoin-core-0.19.1/>
...
From Vadercoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Vadercoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Vadercoin Core does not yet change appearance when
...
- #17488 fix "vadercoind already running" warnings on macOS (fanquake)
