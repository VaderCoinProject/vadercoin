Vadercoin Core version 0.9.2.1 is now available from:

  https://vadercoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 VADE to 0.01 VADE
...
- Fix "Start vadercoin on system login"
