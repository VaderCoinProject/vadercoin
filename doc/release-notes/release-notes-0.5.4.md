Vadercoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/vadercoin/files/Vadercoin/vadercoin-0.5.4/
...
http://gitorious.org/vadercoin/vadercoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Vadercoin-Qt notifications under Growl 1.3.
Increase required age of Vadercoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxVadercoin properly when installing Vadercoin-Qt over it. (Windows)
