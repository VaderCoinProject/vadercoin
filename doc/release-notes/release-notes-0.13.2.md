Vadercoin Core version 0.13.2 is now available from:

  <https://vadercoin.org/bin/vadercoin-core-0.13.2/>
...
- #8908 `4a974b2` Update vadercoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow vadercoin-tx to create v2 transactions (btcdrak)
