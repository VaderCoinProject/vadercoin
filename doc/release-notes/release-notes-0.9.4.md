Vadercoin Core version 0.9.4 is now available from:

  https://vadercoin.org/bin/0.9.4/
...
this update is incompatible with the Vadercoin system and could lead to consensus
forks.

Vadercoin Core released binaries from https://vadercoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~vadercoin/+archive/ubuntu/vadercoin
- A third-party or self-compiled Vadercoin Core

upgrade to Vadercoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
