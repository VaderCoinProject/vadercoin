Vadercoin Core version *0.15.2* is now available from:

  <https://vadercoincore.org/bin/vadercoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in vadercoin-tx (TheBlueMatt)
