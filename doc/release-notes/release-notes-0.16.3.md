Vadercoin Core version 0.16.3 is now available from:

  <https://vadercoincore.org/bin/vadercoin-core-0.16.3/>
...
been discovered in Vadercoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` vadercoinconsensus: invalid flags error should be set to `vadercoinconsensus_err` (afk11)
