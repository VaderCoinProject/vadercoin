Vadercoin Core version 0.14.1 is now available from:

  <https://vadercoin.org/bin/vadercoin-core-0.14.1/>
...
here:
[reducing-vadercoind-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` vadercoin-tx input verification (awemany, jnewbery)
