Vadercoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/vadercoin/files/Vadercoin/vadercoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Vadercoin
...
New/changed settings (command-line or vadercoin.conf file)
--------------------------------------------------------
