Vadercoin Core version 0.10.4 is now available from:

  <https://vadercoin.org/bin/vadercoin-core-0.10.4/>
...
- #6953 `43c2789` Split vadercoin-tx into its own package
- #6953 `dfe0d4d` Include vadercoin-tx binary on Debian/Ubuntu
