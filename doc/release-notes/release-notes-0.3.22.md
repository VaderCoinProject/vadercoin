Download URL: https://sourceforge.net/projects/vadercoin/files/Vadercoin/vadercoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 VADE fee schedule (users still pay 0.01 VADE per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #vadercoin00 - #vadercoin99
