Vadercoin Core version 0.14.2 is now available from:

  <https://vadercoin.org/bin/vadercoin-core-0.14.2/>
...
(in Vadercoin Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate vadercoin-config.h as necessary (theuni)
