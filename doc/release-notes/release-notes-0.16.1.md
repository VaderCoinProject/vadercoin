Vadercoin Core version 0.16.1 is now available from:

  <https://vadercoincore.org/bin/vadercoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting vadercoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure vadercoind processes are cleaned up when tests end (sdaftuar)
