...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Vadercoin
else
  DOCKER_EXEC echo \> \$HOME/.vadercoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/vadercoin/vadercoin/pull/18288#discussion_r433189350 for
  # details.
